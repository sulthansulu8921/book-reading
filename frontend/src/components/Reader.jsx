...
export default function Reader({ title, content, fontSize, darkMode, chapterNum }) {
    ...
    return (
        <div className="max-w-3xl w-full px-8 md:px-12 py-16 md:py-24 mx-auto">
            <motion.div
                key={chapterNum}
            ...
            >
                ...
                <div className="space-y-6 text-center md:text-left">
                    ...
                    <h2 className={`text-4xl md:text-6xl font-black tracking-tight leading-tight ${darkMode ? "text-white" : "text-black"
                        }`}>
                        {title}
                    </h2>
                </div>
